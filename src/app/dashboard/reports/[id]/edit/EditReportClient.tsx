...
export default function EditReportClient({ reportId }: Props) {
  ...
  if (!report) {
    return <div>Report not found or you don't have access to edit it.</div>;
  }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Update the details for report with UIN:{' '}
          <span className="font-mono bg-muted p-1 rounded">{report.uin}</span>
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
